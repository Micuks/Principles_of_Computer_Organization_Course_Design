...
\begin{lstlisting}{language=verilog}
  ...
  module cpu (
    ...
    assign cin = (w1 && (bool_func(union_ir, add) ||
      bool_func(union_ir, dec)));
    ...
    $display("w2[%1b] ldc[%1b] union_ir[%4b] b_f(sub)[%1b]",
      w2, ldc, union_ir, bool_func(union_ir, sub));
    ...
    $display("w2[%1b] m[%1b] union_ir[%4b] b_f(sub)[%1b]",
      w2, m, union_ir, bool_func(union_ir, sub));
    ...
    assign pcadd = w1 && ((bool_func(union_ir, jc) && c) ||
      (bool_func(union_ir, jz) && z));
  
    assign lpc = w1 && (bool_func(union_ir, pc) ||
      bool_func(union_ir, jmp));
    ...
    assign mbus = (w1 && bool_func(union_ir, rsto2)) ||
      (w2 && bool_func(union_ir, ld));
  
    assign memw = (w1 && bool_func(union_ir, wsto2)) ||
      (w2 && bool_func(union_ir, st));
  
    assign arinc = (w1 && (bool_func(union_ir, rsto2) ||
      bool_func(union_ir, wsto2)));
